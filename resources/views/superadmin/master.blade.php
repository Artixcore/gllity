...
<head>
  ...
  <title>Superadmin {{ Auth::user()->name }}</title>
  ...
  @else
      ...
      <li class="nav-item dropdown">
          <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
            <img src="{{ url('public/user')}}/{{ Auth::user()->avatar }}" style="height: 25px; width:25px;  border-radius: 50%;" alt="Avatar">   {{ Auth::user()->name }} <span class="caret"></span>
          </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
        <img src="{{ url('public/user')}}/{{ Auth::user()->avatar }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item has-treeview">
                <a href="{{url('superadmin/slide')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{url('superadmin/companies')}}" class="nav-link">
        ...
        <li class="nav-item has-treeview">
            <a href="{{url('superadmin/service/locations')}}" class="nav-link">
          ...
          <li class="nav-item">
          <a href="{{url('superadmin/categories')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('superadmin/coupons')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ url('superadmin/service') }}" class="nav-link">
